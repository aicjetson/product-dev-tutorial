...
具体的には．https://developer.nvidia.com/embedded/jetpack　こちらからjetpack 4.5~のイメージをダウンロードしていただいてイメージの書き込みをmicroSDにしていただく，もしくは．
https://courses.nvidia.com/courses/course-v1:DLI+S-RX-02+V2/about こちらの最初に取り扱った教材のイメージが4.5以降のバージョンですので，こちらを書き込んでいただくかのどちらかをおこなてください．
```
